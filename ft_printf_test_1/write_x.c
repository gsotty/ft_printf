...
/*   Updated: 2017/01/27 15:21:29 by gsotty           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (struc->lenght.h == 1)
		return (ft_unsigned_itoa_base((short)va_arg(ap, intmax_t), 16));
	else if (struc->lenght.hh == 1)
		return (ft_unsigned_itoa_base((char)va_arg(ap, intmax_t), 16));
	else if (struc->lenght.l == 1)
		return (ft_unsigned_long_itoa_base((long)va_arg(ap, intmax_t), 16));
	else if (struc->lenght.ll == 1)
		return (ft_intmax_t_itoa_base((long long)va_arg(ap, intmax_t), 16));
	else if (struc->lenght.j == 1)
		return (ft_intmax_t_itoa_base((intmax_t)va_arg(ap, intmax_t), 16));
	else if (struc->lenght.z == 1)
		return (ft_unsigned_long_itoa_base((size_t)va_arg(ap, intmax_t), 16));
	else
